...
import 'package:flutter_template/ui/core/themes/typography.dart';
...
@immutable
class _Corners {
  late final double xxs = 2.r;
  late final double xs = 4.r;
  late final double sm = 8.r;
  late final double md = 16.r;
  late final double lg = 24.r;
  late final double xl = 32.r;
}
